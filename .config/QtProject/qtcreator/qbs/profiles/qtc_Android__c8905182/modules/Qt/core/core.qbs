...
Module {
    ...
    property string libFilePathRelease: "/home/luca/Qt-android/5.5/android_armv7/lib/libQt5Core.so"
    property string libFilePath: qtBuildVariant === "debug"
                                      ? libFilePathDebug : libFilePathRelease

    coreLibPaths: ["/opt/android/ndk/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a", "/opt/android/ndk/platforms/android-9/arch-arm//usr/lib"]
    ...
    cpp.includePaths: {
        var paths = ["/home/luca/Qt-android/5.5/android_armv7/include", "/home/luca/Qt-android/5.5/android_armv7/include/QtCore"];
